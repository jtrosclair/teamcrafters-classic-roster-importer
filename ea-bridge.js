...
(function () {
  const RELAYS = [
    ...
    { key: 'tcMascotClipboard', request: 'tc-mascot-clipboard-request', response: 'tc-mascot-clipboard-response' },
    { key: 'tcStadiumClipboard', request: 'tc-stadium-clipboard-request', response: 'tc-stadium-clipboard-response' },
    { key: 'tcSchoolTemplates', request: 'tc-school-templates-request', response: 'tc-school-templates-response' },
  ];
